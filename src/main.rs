...
fn main() {
    ...
    let material_ground = tracer::Material::new(utils::Colour::new(0.8, 0.8, 0.6), tracer::MaterialType::Lambertian);
    let material_center = tracer::Material::new(utils::Colour::new(0.8, 0.2, 0.1), tracer::MaterialType::Lambertian);
    ...
    let light = tracer::Material::new(utils::Colour::new(1.0, 1.0, 1.0), tracer::MaterialType::DiffuseLight);
    ...
    world.objects.push(tracer::Sphere::new(utils::Vector3::new( 0.0, 3.0, -1.0), 2.0, light));
    ...
    let mut cam : tracer::Camera = tracer::Camera::new(utils::Vector3::new(0.0, 0.4, 1.0), utils::Vector3::new(0.0, 0.0, -1.0), 90.0, utils::ASPECT_RATIO);

    //cam.render(&mut world, "outputx.png".to_string());

    cam.render(&mut world, "outputz1.png".to_string());
